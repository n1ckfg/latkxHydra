...
public class Sixense_WorldScale : MonoBehaviour
{

    public Sixense_NewController steamCtlMain;
    public Sixense_NewController steamCtlAlt;
    ...
    private void Update() {
        if (steamCtlMain.bumperDown || steamCtlAlt.bumperDown) {
            target.SetParent(origParent);
            armed = true;
        }

        if (steamCtlMain.bumperPressed && steamCtlAlt.bumperPressed) {
            sevenMode = SevenMode.BOTH;
        } else if (steamCtlMain.bumperPressed && !steamCtlAlt.bumperPressed) {
    ...
    private void attachTargetOne(ref Sixense_NewController ctl) {
